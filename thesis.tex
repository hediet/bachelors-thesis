...
\hypersetup{
 ...
 pdfkeywords={Zellularautomaten, Echtzeit, Speedup}
}
...
\include{chapters/3.LinksunabhAutomaten}
\include{chapters/4.Speedup}
\include{chapters/5.ErweiterteNakamuraKonstruktion}
\include{chapters/6.AdviceZellularautomaten}
\include{chapters/7.EingeschrAutomaten}
